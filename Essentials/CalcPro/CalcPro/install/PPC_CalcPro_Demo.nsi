...
Name "${PRODUCT_NAME}"
OutFile "Pano_CalcPro_Demo_PPC.exe"
...
Section "Calc Pro Demo" SEC01
  ...
  SetOutPath "$INSTDIR"
  File "PPC_CalcPro_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Calc Pro Demo for Windows Mobile Professional."
...
Function .onInit
  ...
  SetOutPath $TEMP
  File /oname=spltmp.bmp "splashdemo.bmp"
