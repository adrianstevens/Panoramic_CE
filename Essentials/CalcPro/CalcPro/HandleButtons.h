...
private:
    ...
    BOOL                OnCharStandard(HWND hWnd, WPARAM wParam, LPARAM lParam, CIssCalculator* oCalc, CCalcBtnManager* oMng);
    BOOL                OnCharQWERTY(HWND hWnd, WPARAM wParam, LPARAM lParam, CIssCalculator* oCalc, CCalcBtnManager* oMng);
    BOOL                OnCharQWERTZ(HWND hWnd, WPARAM wParam, LPARAM lParam, CIssCalculator* oCalc, CCalcBtnManager* oMng);
    BOOL                OnCharAZERTY(HWND hWnd, WPARAM wParam, LPARAM lParam, CIssCalculator* oCalc, CCalcBtnManager* oMng);
