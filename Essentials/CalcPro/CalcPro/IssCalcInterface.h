...
public:
    ...
    BOOL        GetFullscreen(){return m_oBtnManger.GetFullscreen();};
...
private:
    ...
    void		DrawButtons(CIssGDIEx& gdiMem, RECT& rc);
    void        DrawMainButtons(HDC hDC, RECT& rc);
    void        DrawAltButtons(HDC hDC, RECT& rc);
    void        DrawKeyboardButtons(HDC hDC, RECT& rc);
    void        DrawKeyboardButtonsAlt(CIssGDIEx& gdiMem, RECT& rc);
    ...
    void        DrawDisplayTextRPN(HDC hDC, RECT& rc);
	...
	BOOL		InitButton(CCalcDynBtn* oDynButton, RECT* rc, CalcProSkins* oSkin, int iSkinIndex, int iWidth, int iHeight, BOOL bNoDropShad = FALSE);//helper function ... keeps things tidy
	...
	static void DrawMenuItem(CIssGDIEx& gdi, RECT& rcDraw, TypeItems* sItem, BOOL bIsHighlighted, LPVOID lpClass);
	void        DrawMenuItem(CIssGDIEx& gdi, RECT& rcDraw, TypeItems* sItem, BOOL bIsHighlighted);
    ...
    static void DrawRPNItem(CIssGDIEx& gdi, RECT& rcDraw, TypeItems* sItem, BOOL bIsHighlighted, LPVOID lpClass);
    void        DrawRPNItem(CIssGDIEx& gdi, RECT& rcDraw, TypeItems* sItem, BOOL bIsHighlighted);
...
private: 
	...
	CIssUnitInterface m_oUnitInt;
    CIssCurInterface m_oCurInt;
    CIssDateInterface m_oDateInt;
    CIssGraphInterface m_oGraphInt;
    CIssConstantsInterface m_oConstInt;
    CObjConstants   m_oConstants;
    
	CIssDynDisplay	m_oDisplay;

    CWSheetManager  m_oWSMan;
    ...
    CIssVector<CCalcDynBtn>         m_arrKeyboardButtons;//smartphone only for now 
    ...
    HFONT       m_hFontMenu;
    HFONT       m_hFontRPN;//yeah what's one more font
    HFONT       m_hFontBtnLabels;
