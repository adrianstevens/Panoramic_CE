...
!define PRODUCT_NAME "Panoramic Financial Calc"
!define PRODUCT_VERSION "1.0.0"
!define PRODUCT_PUBLISHER "Panoramic Software Inc."
!define PRODUCT_WEB_SITE "http://www.panoramicsoft.com"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\Financial.exe"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"

Name "${PRODUCT_NAME}"
OutFile "Pano_Financial_Demo_PPC.exe"
InstallDir "$PROGRAMFILES\Panoramic\FinancialCalc"
...
Section "Financial Calc Demo" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_Financial_Demo.ARM720.CAB"
  FILE "PPC_Install_Demo.ini"

  StrCpy $0 "$INSTDIR\PPC_Install_Demo.ini"
  Call InstallCAB
...
;  CreateShortCut "$SMPROGRAMS\Financial\Website.lnk" "$INSTDIR\${PRODUCT_NAME}.url"
;  CreateShortCut "$SMPROGRAMS\Financial\Uninstall.lnk" "$INSTDIR\uninst.exe"
;SectionEnd

;Section -Post
;  WriteUninstaller "$INSTDIR\uninst.exe"
;  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\Financial.exe"
;  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
;  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
;  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\Financial.exe"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Financial Calc Demo for Windows Mobile Professional."
!insertmacro MUI_FUNCTION_DESCRIPTION_END

Function .onInit
  ; check for another instance of this installer
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "Financial Calc Installer") i .r1 ?e'
  Pop $R0
  StrCmp $R0 0 +3
