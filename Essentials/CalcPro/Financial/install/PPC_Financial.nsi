...
Name "${PRODUCT_NAME}"
OutFile "Pano_Financial_PPC.exe"
...
Section "Financial Calc" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_Financial.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Financial Calc for Windows Mobile Professional."
