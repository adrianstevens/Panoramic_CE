...
Name "${PRODUCT_NAME}"
OutFile "Pano_Scientific_Demo_PPC.exe"
...
Section "Scientific Calc Demo" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_Scientific_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Scientific Calc Demo for Windows Mobile Professional."
