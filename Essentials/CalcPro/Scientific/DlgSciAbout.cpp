...
CDlgSciAbout::CDlgSciAbout(void)
:m_oMenu(NULL)
{
...
BOOL CDlgSciAbout::OnInitDialog(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
...
BOOL CDlgSciAbout::OnDestroy(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
	return TRUE;
}

BOOL CDlgSciAbout::OnPaint(HWND hWnd, HDC hDC, RECT& rcClient)
{
	RECT rcClip;
...
BOOL CDlgSciAbout::OnLButtonDown(HWND hWnd, POINT& pt)
{
...
BOOL CDlgSciAbout::OnLButtonUp(HWND hWnd, POINT& pt)
{
...
BOOL CDlgSciAbout::DrawBackground(HDC hdc, RECT rcClip)
{
    RECT rcClient;
...
BOOL CDlgSciAbout::DrawAboutText(HDC hdc, RECT rcClip)
{
    RECT rcClient;
    GetClientRect(m_hWnd, &rcClient);
    ...
    m_oStr->Format(szTemp, _T("Panoramic Scientific Calc\r\n%s 2.9.2\r\nCopyright 2007-2010\r\nAll rights reserved\r\n\r\n"), szState);
...
BOOL CDlgSciAbout::OnKeyUp(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
#ifdef UNDER_CE
    switch(wParam)
    {
...
BOOL CDlgSciAbout::OnCommand(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
...
BOOL CDlgSciAbout::OnSize(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
    RECT rc;
...
BOOL CDlgSciAbout::OnActivate(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
    HWND hWndSip = NULL;
...
BOOL CDlgSciAbout::OnUser(HWND hWnd, UINT uiMessage, WPARAM wParam, LPARAM lParam)
{
