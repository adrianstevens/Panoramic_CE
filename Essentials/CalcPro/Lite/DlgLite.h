...
class CDlgLite:public CIssWnd
{
public:
	CDlgLite(HINSTANCE hInst);
	~CDlgLite(void);
...
protected:
	...
	BOOL	OnHelp(HWND hWnd, WPARAM wParam, LPARAM lParam){CreateProcess(_T("peghelp"), _T("PanoCalcProLite.htm#HowTo"), NULL, NULL, FALSE, 0, NULL, NULL, NULL, NULL);return TRUE;};
