...
!define PRODUCT_NAME "Panoramic Calc Pro Lite"
...
Name "${PRODUCT_NAME}"
OutFile "Pano_CalcProLite_Demo_PPC.exe"
InstallDir "$PROGRAMFILES\Panoramic\CalcProLite"
...
Section "Calc Pro Lite Demo" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_CalcProLite_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Calc Pro Lite Demo for Windows Mobile Professional."
!insertmacro MUI_FUNCTION_DESCRIPTION_END

Function .onInit
  ; check for another instance of this installer
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "Calc Pro Lite Installer") i .r1 ?e'
  Pop $R0
  StrCmp $R0 0 +3
