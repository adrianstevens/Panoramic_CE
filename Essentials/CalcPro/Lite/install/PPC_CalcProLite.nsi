...
Name "${PRODUCT_NAME}"
OutFile "Pano_CalcProLite_PPC.exe"
...
Section "Calc Pro Lite" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_CalcProLite.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Calc Pro Lite for Windows Mobile Professional."
