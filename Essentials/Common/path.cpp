...
BOOL WINAPI PathMakeUniqueName(LPCTSTR lpszPath,
                   LPCTSTR lpszT1,
                   LPCTSTR lpszT2,
                   BOOL    bLink,
...
BOOL WINAPI PathMakeUniqueNameEx(LPCTSTR lpszPath,
                     LPCTSTR lpszT1,
                     LPCTSTR lpszT2,
                     BOOL    bLink,
                     ...
                     UINT    cchUniqueName)
{
    ...
    if (bLink)
    {
        StringCchCopy(szPath, cchPath, PathFindFileName(lpszPath));
    ...
    do
    {
        ...
        {
            StringCchCat(szPath, cchPath, PathFindFileName(lpszPath));
            if (bLink)
            {
                PathRemoveStem(szPath, bSourceIsDirectory);
            }
