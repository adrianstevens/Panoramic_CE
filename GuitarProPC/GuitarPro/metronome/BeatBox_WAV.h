...
public:
    ...
    virtual void SetTempo(unsigned long const BeatsPerMinute) {m_BeatsPerMinute = BeatsPerMinute; Create1MinOfSamples();}; //See IBeatBox
    virtual void SetInstrumentVolume(unsigned long const nInstrumentNum, char const nVolume) {m_aVolumes[nInstrumentNum] = nVolume; Create1MinOfSamples();}; //See IBeatBox
    virtual void SetInstrument      (unsigned long const nInstrumentNum, int  const nInstrument) {m_aInstruments[nInstrumentNum] = nInstrument; Create1MinOfSamples();}; //See IBeatBox
