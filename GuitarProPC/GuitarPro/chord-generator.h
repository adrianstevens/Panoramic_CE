...
public:
	...
	void SetOpenStrings(int i1, int i2, int i3, int i4, int i5, int i6, int iStringCount = 6);
    ...
    int getNumStrings(){return iNumStrings;};
    int getStringIndent(){return NUM_STRINGS - iNumStrings;};//hackish

	void Reset();//clear it out

	void SetScoreVars(bool bBass = false);
