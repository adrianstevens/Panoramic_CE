...
Name "${PRODUCT_NAME}"
OutFile "Pano_Blackjack_Demo_SP.exe"
...
Section "Blackjack Demo" SEC01
  ...
  SetOutPath "$INSTDIR"
  File "SP_Blackjack_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Blackjack Demo for Windows Mobile Standard."
