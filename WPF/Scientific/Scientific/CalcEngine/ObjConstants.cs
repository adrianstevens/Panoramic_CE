    ...
    public class ObjConstants
    {
        ...
        public bool SaveFavorites()
        {
            ...
            try
            {
                ...
                TextWriter writer = new StreamWriter(FILE_Favorites);
                ser.Serialize(writer, arrFavorites);
            }
        ...
        public bool ReadFavorites()
        {
            ...
            try
            {
                TextReader reader = new StreamReader(FILE_Favorites);
                //and serialize data
                XmlSerializer ser = new XmlSerializer(typeof(List<FavoriteItem>));
                arrFavorites = (List<FavoriteItem>)ser.Deserialize(reader);
