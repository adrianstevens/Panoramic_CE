...
namespace Visual
{
    public class MagicDot : Canvas
    {
        ...
        private static int ELLIPSE_COUNT = 4; // default is 5      // Number of ellipse make up of the magic dot
        ...
        // for firwork
        public double FireworkOpacityInc = -0.017;
        public double XVelocity = 1;
        public double YVelocity = 1;
        
        public double XGravity = 1;
