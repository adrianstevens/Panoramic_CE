...
void CDlgOptions::DrawText()
{
	...
	MyDrawText(IDS_LBL_PlaySounds, m_rcLabelPlaySounds);
	MyDrawText(IDS_LBL_CardCountView, m_rcLabelCardCountView);
	MyDrawText(IDS_LBL_CardCounting, m_rcLabelCardCounting);
	MyDrawText(IDS_LBL_GameDifficulty, m_rcLabelDifficulty);
...
void CDlgOptions::CreateControls()
{
    ...
    m_oStr->StringCopy(szText, IDS_CMB_GD_Easy, STRING_MAX, m_hInst);
    ListAddString(m_lstGameDifficulty, szText);
    m_oStr->StringCopy(szText, IDS_CMB_GD_Normal, STRING_MAX, m_hInst);
    ListAddString(m_lstGameDifficulty, szText);
    m_oStr->StringCopy(szText, IDS_CMB_GD_Difficult, STRING_MAX, m_hInst);
    ListAddString(m_lstGameDifficulty, szText);
    m_oStr->StringCopy(szText, IDS_CMB_GD_Learn, STRING_MAX, m_hInst);
    ListAddString(m_lstGameDifficulty, szText);
    ListSetCurSel(m_lstGameDifficulty, (int)m_psOptions->eGameDifficulty);

    // set the card count view items
    m_oStr->StringCopy(szText, IDS_CMB_CCV_On, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCountView, szText);
    m_oStr->StringCopy(szText, IDS_CMB_CCV_Off, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCountView, szText);
#ifdef WIN32_PLATFORM_PSPC
    m_oStr->StringCopy(szText, IDS_CMB_CCV_Semi, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCountView, szText);
#endif
    ListSetCurSel(m_lstCardCountView, (int)m_psOptions->eCardCountView);

    // set the game difficulty items
    m_oStr->StringCopy(szText, IDS_CMB_CC_Wizard, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCounting, szText);
    m_oStr->StringCopy(szText, IDS_CMB_CC_KO, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCounting, szText);
    m_oStr->StringCopy(szText, IDS_CMB_CC_HiLow, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCounting, szText);
    m_oStr->StringCopy(szText, IDS_CMB_CC_HiOpt1, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCounting, szText);
    m_oStr->StringCopy(szText, IDS_CMB_CC_HiOpt2, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCounting, szText);
    m_oStr->StringCopy(szText, IDS_CMB_CC_Zen, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCounting, szText);
    m_oStr->StringCopy(szText, IDS_CMB_CC_OmegaII, STRING_MAX, m_hInst);
    ListAddString(m_lstCardCounting, szText);
