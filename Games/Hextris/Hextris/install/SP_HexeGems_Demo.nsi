...
Name "${PRODUCT_NAME}"
OutFile "Pano_HexeGems_Demo_SP.exe"
...
Section "HexeGems Demo" SEC01
  ...
  SetOutPath "$INSTDIR"
  File "SP_Hexegems_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install HexeGems Demo for Windows Mobile Standard."
