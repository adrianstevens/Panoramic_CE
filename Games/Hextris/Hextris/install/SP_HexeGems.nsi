...
Section "HexeGems" SEC01

  SetOutPath "$INSTDIR"
  File "SP_HexeGems.ARM720.CAB"
  FILE "SP_Install.ini"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install HexeGems for Windows Mobile Standard."
