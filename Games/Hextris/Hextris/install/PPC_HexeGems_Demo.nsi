...
!define PRODUCT_NAME "Panoramic HexeGems"
...
Name "${PRODUCT_NAME}"
OutFile "Pano_HexeGems_Demo_PPC.exe"
InstallDir "$PROGRAMFILES\Panoramic\HexeGems"
...
Section "HexeGems Demo" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_HexeGems_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install HexeGems Demo for Windows Mobile Professional."
!insertmacro MUI_FUNCTION_DESCRIPTION_END

Function .onInit
  ; check for another instance of this installer
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "HexeGems Installer") i .r1 ?e'
  Pop $R0
  StrCmp $R0 0 +3
