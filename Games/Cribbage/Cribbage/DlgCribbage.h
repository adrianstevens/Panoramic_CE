...
class CDlgCribbage:public CIssWnd
{
public:
	CDlgCribbage(void);
	~CDlgCribbage(void);
...
protected:
    CIssCribbage* GetGame(){return &m_oGame;};
	...
	//BOOL	OnHelp(HWND hWnd, WPARAM wParam, LPARAM lParam){CreateProcess(_T("peghelp"), _T("PanoCribbage.htm#HowTo"), NULL, NULL, FALSE, 0, NULL, NULL, NULL, NULL);return TRUE;};
