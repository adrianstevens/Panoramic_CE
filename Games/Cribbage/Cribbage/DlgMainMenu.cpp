...
void CDlgMainMenu::LaunchHelp(HWND hWnd, HINSTANCE hInst)
{
	...
	{
	case LANG_KOREAN:
		oStr->StringCopy(szHelpFile, _T("PanoCribbage_ko.htm"));
		break;
	case LANG_PORTUGUESE:
		oStr->StringCopy(szHelpFile, _T("PanoCribbage_pt.htm"));
		break;
	case LANG_FRENCH:
		oStr->StringCopy(szHelpFile, _T("PanoCribbage_fr.htm"));
		break;
	case LANG_GERMAN:
		oStr->StringCopy(szHelpFile, _T("PanoCribbage_de.htm"));
		break;
	case LANG_DUTCH:
		oStr->StringCopy(szHelpFile, _T("PanoCribbage_du.htm"));
		break;
    case LANG_JAPANESE:
        oStr->StringCopy(szHelpFile, _T("PanoCribbage_jp.htm"));
        break;
	default:
		oStr->StringCopy(szHelpFile, _T("PanoCribbage.htm"));
		break;
	}
