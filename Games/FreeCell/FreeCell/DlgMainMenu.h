...
public:
	CDlgMainMenu(void);
	~CDlgMainMenu(void);
	void	Init(BOOL bIsGameInPlay, CIssFreeCell* oGame){m_bIsGameInPlay = bIsGameInPlay; m_oGame = oGame;};
...
private:	// variables
    ...
    CIssFreeCell*   m_oGame;                    // just gonna pass it into the options screen
