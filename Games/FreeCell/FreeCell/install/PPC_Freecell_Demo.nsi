...
!define PRODUCT_NAME "Panoramic Freecell"
...
Name "${PRODUCT_NAME}"
OutFile "Pano_Freecell_demo_PPC.exe"
InstallDir "$PROGRAMFILES\Pano\Freecell"
...
Section "FreeCell Demo" SEC01
  ...
  SetOutPath "$INSTDIR"
  File "PPC_Freecell_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Freecell for Windows Mobile Professional."
