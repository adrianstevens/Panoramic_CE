							  ...
							  WORD    cFailedShortcuts)
{
    ...
    if(!bIsSmartphone)
    {
        ...
        CIssLocalisation::GetRegGamesFolder(szRegKey, 2*STRING_MAX, _T("Panoramic Blackjack"));
        ...
        if(ERROR_SUCCESS == RegCreateKeyEx(HKEY_LOCAL_MACHINE, szRegKey, 0, NULL, 0, 0, NULL, &hKey, NULL))
        {
            ...
            oStr->Concatenate(szValue, _T("\\Blackjack90x90_192.png"));
								  ...
								  LPCTSTR     pszInstallDir)
{
    ...
    HWND hWndMo = FindWindow(_T("ClassBlackjack"), _T("Panoramic Blackjack"));
    if(hWndMo)
    {
