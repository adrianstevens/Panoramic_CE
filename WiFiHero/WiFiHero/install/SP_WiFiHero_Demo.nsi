...
Name "${PRODUCT_NAME}"
OutFile "Pano_WiFiHero_Demo_SP.exe"
...
Section "WiFiHero Demo" SEC01

  SetOutPath "$INSTDIR"
  File "SP_WiFiHero_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install WiFi Hero Demo for Windows Mobile Standard."
