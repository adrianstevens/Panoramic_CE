...
!define PRODUCT_NAME "Panoramic WiFi Hero"
...
Name "${PRODUCT_NAME}"
OutFile "Pano_WiFiHero_Demo_PPC.exe"
InstallDir "$PROGRAMFILES\Panoramic\WiFiHero"
...
Section "WiFiHero" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_WiFiHero.ARM720.CAB"
...
;  CreateShortCut "$SMPROGRAMS\WiFiHero\Website.lnk" "$INSTDIR\${PRODUCT_NAME}.url"
;  CreateShortCut "$SMPROGRAMS\WiFiHero\Uninstall.lnk" "$INSTDIR\uninst.exe"
;SectionEnd

;Section -Post
;  WriteUninstaller "$INSTDIR\uninst.exe"
;  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\WifiHero.exe"
;  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
;  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
;  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\WiFiHero.exe"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install WiFi Hero for Windows Mobile Professional."
!insertmacro MUI_FUNCTION_DESCRIPTION_END

Function .onInit
  ; check for another instance of this installer
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "WiFiHero Installer") i .r1 ?e'
  Pop $R0
  StrCmp $R0 0 +3
