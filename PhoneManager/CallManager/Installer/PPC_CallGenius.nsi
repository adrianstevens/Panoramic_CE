...
Name "${PRODUCT_NAME}"
OutFile "Pano_CallGenius_PPC.exe"
...
Section "Panoramic Call Genius" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_CallGenius.ARM720.CAB"
  FILE "PPC_CallGenius.ini"

  StrCpy $0 "$INSTDIR\PPC_CallGenius.ini"
  Call InstallCAB
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Call Genius for Windows Mobile Professional."
