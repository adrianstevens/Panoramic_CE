...
void CDlgPostCall::SetBattery(int iPcnt)
{
...
void CDlgPostCall::SetSignal(int iPcnt)
{
...
void CDlgPostCall::SetCallerName(TCHAR* szName)
{
    if(szName)
...
void CDlgPostCall::SetCallerNumber(TCHAR* szNumber)
{
    if(szNumber)
...
void CDlgPostCall::SetOID(LONG lOid)
{
    m_lOid = lOid;
}

void CDlgPostCall::SetCallType(TCHAR* szCallType)
{
    if(szCallType == NULL)
        return;

    m_oStr->StringCopy(m_szPhoneType, szCallType);
}

void CDlgPostCall::SetCarrier(TCHAR* szCarrier)
{
    if(szCarrier == NULL)
        return;
...
void CDlgPostCall::SetTime(TCHAR* szTime)
{
    if(szTime == NULL)
        return;
