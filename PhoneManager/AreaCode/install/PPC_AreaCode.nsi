...
Section "Panoramic Area Code Genius" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_AreaCode.ARM720.CAB"
  FILE "PPC_AreaCode.ini"

  StrCpy $0 "$INSTDIR\PPC_AreaCode.ini"
  Call InstallCAB
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Area Code Genius for Windows Mobile Professional."
!insertmacro MUI_FUNCTION_DESCRIPTION_END

Function .onInit
  ; check for another instance of this installer
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "Area Code Genius Installer") i .r1 ?e'
  Pop $R0
  StrCmp $R0 0 +3
