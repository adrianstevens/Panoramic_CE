...
void CDlgOptions::DrawTopBar(CIssGDIEx& gdi, RECT& rcClient, RECT& rcClip)
{
    RECT rc = m_rcTitle;
    rc.left += INDENT;
    DrawText(gdi, m_oStr->GetText(ID(IDS_MENU_Options), m_hInst), rc, DT_LEFT | DT_VCENTER, m_hFontLabel, RGB(51,51,51));
...
BOOL CDlgOptions::DrawButtonItem(CIssGDIEx& gdi, BOOL bIsHighlighted, RECT& rc, EnumOption* eOption)
{
    ...
    DrawText(gdi, szInfo, rcText, DT_RIGHT, m_hFontBtnText, (bIsHighlighted?RGB(0,0,0):RGB(167,167,167)));
...
void CDlgOptions::DrawBottomBar(CIssGDIEx& gdi, RECT& rcClient, RECT& rcClip)
{
    ...
    if(!m_wndMenu.IsWindowUp(FALSE))
    {
        ...
        DrawTextShadow(gdi, m_oStr->GetText(ID(IDS_MENU_Ok)), rc, DT_CENTER|DT_VCENTER, m_hFontLabel, RGB(255,255,255), RGB(0,0,0));
    }

    rc = m_rcBottomBar;
    rc.left = m_rcBottomBar.right/2;
    DrawTextShadow(gdi, m_oStr->GetText(ID(IDS_MENU_Cancel)), rc, DT_CENTER|DT_VCENTER, m_hFontLabel, RGB(255,255,255), RGB(0,0,0));
}
...
void CDlgOptions::LaunchPopupMenu()
{
    ...
    case OPTION_Language:
    {
        ...
        m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_ENGLISH?FLAG_Radio:NULL), LANG_ENGLISH);
        g_cLocale.GetLanguageText(szText, LANG_SPANISH);
        m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_SPANISH?FLAG_Radio:NULL), LANG_SPANISH);
        g_cLocale.GetLanguageText(szText, LANG_FRENCH);
        m_wndMenu.AddItem(szText,  IDMENU_Selection, (dwCurrent == LANG_FRENCH?FLAG_Radio:NULL), LANG_FRENCH);
        //g_cLocale.GetLanguageText(szText, LANG_HINDI);
        //m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_HINDI?FLAG_Radio:NULL), LANG_HINDI);
        //g_cLocale.GetLanguageText(szText, LANG_ITALIAN);
        //m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_ITALIAN?FLAG_Radio:NULL), LANG_ITALIAN);
        //g_cLocale.GetLanguageText(szText, LANG_JAPANESE);
        //m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_JAPANESE?FLAG_Radio:NULL), LANG_JAPANESE);
        //g_cLocale.GetLanguageText(szText, LANG_PORTUGUESE);
        //m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_PORTUGUESE?FLAG_Radio:NULL), LANG_PORTUGUESE);
        g_cLocale.GetLanguageText(szText, LANG_GERMAN);
        m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_GERMAN?FLAG_Radio:NULL), LANG_GERMAN);
        //g_cLocale.GetLanguageText(szText, LANG_DUTCH);
        //m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_DUTCH?FLAG_Radio:NULL), LANG_DUTCH);
        //g_cLocale.GetLanguageText(szText, LANG_CHINESE);
        //m_wndMenu.AddItem(szText, IDMENU_Selection, (dwCurrent == LANG_CHINESE?FLAG_Radio:NULL), LANG_CHINESE);
        break;
     }
     case OPTION_AlwaysShowText:
        m_wndMenu.AddItem(ID(IDS_On), m_hInst, IDMENU_Selection, (m_sOptions.bAlwaysShowText?FLAG_Radio:NULL), TRUE);
        m_wndMenu.AddItem(ID(IDS_Off), m_hInst, IDMENU_Selection, (!m_sOptions.bAlwaysShowText?FLAG_Radio:NULL), FALSE);
        break;
    case OPTION_HideOnAppLaunch:
        m_wndMenu.AddItem(ID(IDS_On), m_hInst, IDMENU_Selection, (m_sOptions.bHideOnAppLaunch?FLAG_Radio:NULL), TRUE);
        m_wndMenu.AddItem(ID(IDS_Off), m_hInst, IDMENU_Selection, (!m_sOptions.bHideOnAppLaunch?FLAG_Radio:NULL), FALSE);
        break;
    case OPTION_TodayMenuItem:
        m_wndMenu.AddItem(ID(IDS_On), m_hInst, IDMENU_Selection, (m_bSetTodayMenu?FLAG_Radio:NULL), TRUE);
        m_wndMenu.AddItem(ID(IDS_Off), m_hInst, IDMENU_Selection, (!m_bSetTodayMenu?FLAG_Radio:NULL), FALSE);
        break;
    case OPTION_StartMenu:
        m_wndMenu.AddItem(ID(IDS_On), m_hInst, IDMENU_Selection, (m_bStartMenuOn?FLAG_Radio:NULL), TRUE);
        m_wndMenu.AddItem(ID(IDS_Off), m_hInst, IDMENU_Selection, (!m_bStartMenuOn?FLAG_Radio:NULL), FALSE);
        break;
    case OPTION_SettingsHeaders:
        m_wndMenu.AddItem(ID(IDS_On), m_hInst, IDMENU_Selection, (m_sOptions.bShowSettingsHeaders?FLAG_Radio:NULL), TRUE);
        m_wndMenu.AddItem(ID(IDS_Off), m_hInst, IDMENU_Selection, (!m_sOptions.bShowSettingsHeaders?FLAG_Radio:NULL), FALSE);
        break;
    case OPTION_ColorScheme:
        m_wndMenu.AddItem(ID(IDS_COLOR_Blue), m_hInst, IDMENU_Selection, (m_eColorScheme==COLOR_Blue?FLAG_Radio:NULL), COLOR_Blue);
        m_wndMenu.AddItem(ID(IDS_COLOR_Green), m_hInst, IDMENU_Selection, (m_eColorScheme==COLOR_Green?FLAG_Radio:NULL), COLOR_Green);
        m_wndMenu.AddItem(ID(IDS_COLOR_Orange), m_hInst, IDMENU_Selection, (m_eColorScheme==COLOR_Orange?FLAG_Radio:NULL), COLOR_Orange);
        m_wndMenu.AddItem(ID(IDS_COLOR_Pink), m_hInst, IDMENU_Selection, (m_eColorScheme==COLOR_Pink?FLAG_Radio:NULL), COLOR_Pink);
        m_wndMenu.AddItem(ID(IDS_COLOR_Purple), m_hInst, IDMENU_Selection, (m_eColorScheme==COLOR_Purple?FLAG_Radio:NULL), COLOR_Purple);
        m_wndMenu.AddItem(ID(IDS_COLOR_Red), m_hInst, IDMENU_Selection, (m_eColorScheme==COLOR_Red?FLAG_Radio:NULL), COLOR_Red);
        break;
    case OPTION_FavSize:
        m_wndMenu.AddItem(ID(IDS_Large), m_hInst, IDMENU_Selection, (m_sOptions.eFavSize==FAVSIZE_Large?FLAG_Radio:NULL), FAVSIZE_Large);
        m_wndMenu.AddItem(ID(IDS_Normal), m_hInst, IDMENU_Selection, (m_sOptions.eFavSize==FAVSIZE_Normal?FLAG_Radio:NULL), FAVSIZE_Normal);
        m_wndMenu.AddItem(ID(IDS_Small), m_hInst, IDMENU_Selection, (m_sOptions.eFavSize==FAVSIZE_Small?FLAG_Radio:NULL), FAVSIZE_Small);
        break;
    case OPTION_IconStyle:
        m_wndMenu.AddItem(ID(IDS_Windows), m_hInst, IDMENU_Selection, (m_eIconStyle==ICON_Windows?FLAG_Radio:NULL), ICON_Windows);
        m_wndMenu.AddItem(ID(IDS_Rocket), m_hInst, IDMENU_Selection, (m_eIconStyle==ICON_Rocket?FLAG_Radio:NULL), ICON_Rocket);
        m_wndMenu.AddItem(ID(IDS_Default), m_hInst, IDMENU_Selection, (m_eIconStyle==ICON_Default?FLAG_Radio:NULL), ICON_Default);
        m_wndMenu.AddItem(ID(IDS_Off), m_hInst, IDMENU_Selection, (m_eIconStyle==ICON_Off?FLAG_Radio:NULL), ICON_Off);
        break;
    case OPTION_SlideLeft:
        m_wndMenu.AddItem(ID(IDS_SLIDER_Programs), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Programs?FLAG_Radio:NULL), SLIDE_Programs);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Games), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Games?FLAG_Radio:NULL), SLIDE_Games);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Apps), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Apps?FLAG_Radio:NULL), SLIDE_Apps);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Settings), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Settings?FLAG_Radio:NULL), SLIDE_Settings);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Favorites), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Favorites?FLAG_Radio:NULL), SLIDE_Favorites);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Utilities), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Utilities?FLAG_Radio:NULL), SLIDE_Utilities);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Music), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Music?FLAG_Radio:NULL), SLIDE_Music);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Folders), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Folders?FLAG_Radio:NULL), SLIDE_Folders);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Files), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Files?FLAG_Radio:NULL), SLIDE_Files);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Videos), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Videos?FLAG_Radio:NULL), SLIDE_Videos);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Pictures), m_hInst, IDMENU_Selection, (m_sOptions.eSlideLeft==SLIDE_Pictures?FLAG_Radio:NULL), SLIDE_Pictures);
        break;
    case OPTION_SlideRight:
        m_wndMenu.AddItem(ID(IDS_SLIDER_Programs), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Programs?FLAG_Radio:NULL), SLIDE_Programs);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Games), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Games?FLAG_Radio:NULL), SLIDE_Games);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Apps), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Apps?FLAG_Radio:NULL), SLIDE_Apps);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Settings), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Settings?FLAG_Radio:NULL), SLIDE_Settings);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Favorites), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Favorites?FLAG_Radio:NULL), SLIDE_Favorites);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Utilities), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Utilities?FLAG_Radio:NULL), SLIDE_Utilities);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Music), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Music?FLAG_Radio:NULL), SLIDE_Music);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Folders), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Folders?FLAG_Radio:NULL), SLIDE_Folders);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Files), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Files?FLAG_Radio:NULL), SLIDE_Files);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Videos), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Videos?FLAG_Radio:NULL), SLIDE_Videos);
        m_wndMenu.AddItem(ID(IDS_SLIDER_Pictures), m_hInst, IDMENU_Selection, (m_sOptions.eSlideRight==SLIDE_Pictures?FLAG_Radio:NULL), SLIDE_Pictures);
        break;
    }
