...
Section "Pano PhoneManager" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_PhoneManager.ARM720.CAB"
  FILE "PPC_PhoneManager.ini"

  StrCpy $0 "$INSTDIR\PPC_PhoneManager.ini"
  Call InstallCAB
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Phone Manager for Windows Mobile Professional."
