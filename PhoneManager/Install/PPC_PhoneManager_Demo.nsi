...
!define PRODUCT_NAME "Panoramic Phone Manager"
!define PRODUCT_VERSION "1.0.0"
!define PRODUCT_PUBLISHER "Panoramic Software Inc."
!define PRODUCT_WEB_SITE "http://www.panoramicsoft.com"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\PhoneManager.exe"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"

Name "${PRODUCT_NAME}"
OutFile "Pano_PhoneManager_PPC.exe"
InstallDir "$PROGRAMFILES\Panoramic\PhoneManager"
...
Section "Pano PhoneManager Demo" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_PhoneManager_Demo.ARM720.CAB"
  FILE "PPC_PhoneManager_Demo.ini"

  StrCpy $0 "$INSTDIR\PPC_PhoneManager_Demo.ini"
  Call InstallCAB
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Phone Manager Demo for Windows Mobile Professional."
!insertmacro MUI_FUNCTION_DESCRIPTION_END

Function .onInit
  ; check for another instance of this installer
  System::Call 'kernel32::CreateMutexA(i 0, i 0, t "Phone Manager Installer") i .r1 ?e'
  Pop $R0
  StrCmp $R0 0 +3
