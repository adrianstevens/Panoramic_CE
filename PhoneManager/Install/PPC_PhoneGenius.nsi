...
Name "${PRODUCT_NAME}"
OutFile "Pano_PhoneGenius_PPC.exe"
...
Section "Panoramic Phone Genius" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_PhoneGenius.ARM720.CAB"
  FILE "PPC_PhoneGenius.ini"

  StrCpy $0 "$INSTDIR\PPC_PhoneGenius.ini"
  Call InstallCAB
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Phone Genius for Windows Mobile Professional."
