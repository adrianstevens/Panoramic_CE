...
BOOL CGuiMetronome::OnSize(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
    ...
    m_rcTap.left -= GetSystemMetrics(SM_CXICON);
    m_rcTap.right += GetSystemMetrics(SM_CXICON);
