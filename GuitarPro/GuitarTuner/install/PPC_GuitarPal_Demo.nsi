...
!define PRODUCT_NAME "Panoramic Guitar Pal"
...
Name "${PRODUCT_NAME}"
OutFile "Pano_GuitarPal_Demo_PPC.exe"
InstallDir "$PROGRAMFILES\Panoramic\GuitarPal"
...
Section "Guitar Pal Demo" SEC01

  SetOutPath "$INSTDIR"
  File "PPC_GuitarPal_Demo.ARM720.CAB"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Install Blackjack Demo for Windows Mobile Professional."
