...
#define ITEMHEIGHT_Text         (GetSystemMetrics(SM_CXICON)*29/32)
#define TEXT_Height             (GetSystemMetrics(SM_CXICON)*15/32)
#define ITEMHEIGHT_Separator    (IsVGA()?2:1)
#define INDENT                  (GetSystemMetrics(SM_CXICON)/4)
#define SCROLLBAR_Height        (GetSystemMetrics(SM_CXICON)*5/7)
